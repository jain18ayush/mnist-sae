...
train_loader = torch.utils.data.DataLoader(
  torchvision.datasets.EMNIST(root='./data', split='letters', train=True, download=True,
...
test_loader = torch.utils.data.DataLoader(
  torchvision.datasets.EMNIST(root='./data', split='letters', train=False, download=True,
                             transform=torchvision.transforms.Compose([
                               torchvision.transforms.ToTensor(),
                               torchvision.transforms.Normalize(
                                 (0.1307,), (0.3081,))
...
for epoch in range(num_epochs):
    ...
    with torch.no_grad():
        ...
        if best_accuracy1>= correct1 / total1:
            curr_lr1 = learning_rate * pow(np.random.rand(1), 3).item()  # Changed from np.asscalar to .item()
